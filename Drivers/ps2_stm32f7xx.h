/* stm32f7xx processor family dependent things */

#ifndef __PS2_STM32F7XX_H__
#define __PS2_STM32F7XX_H__
...
#define RCC_PIN_DEBUG_INIT  RCC->AHB1ENR |= GPIOX_CLOCK(PS2_PIN_DEBUG_1) | GPIOX_CLOCK(PS2_PIN_DEBUG_2)
